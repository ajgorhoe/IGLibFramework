...
<a href="./IGLibDependencyGraph.jpg">
  <img src="./IGLibDependencyGraph.jpg" alt = [Trefoil knot rendered with ray tracer image, transparent background] style = "max-width: 50%; max-width: 20em; width: 300pt" ></img>
</a>
...
<a href="./IGLibDependencyGraph.svg">
  <img src="./IGLibDependencyGraph.svg" alt = [Trefoil knot rendered with ray tracer image, transparent background] style = "max-width: 50%; max-width: 20em; width: 300pt" ></img>
</a>
